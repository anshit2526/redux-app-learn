...
const Shop = () => {
    ...
    return (
        <div className='my-3'>
            ...
            <button className="btn btn-primary btn-sm mx-2" onClick={() => { withdrawMoney(100) }}>-</button>
            Update Money
            <button className="btn btn-primary btn-sm mx-2" onClick={() => { depositMoney(100) }}>+</button>
        </div>
    )
}
